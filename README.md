<p align="center">
  <img src="assets/moon.png" width="110" alt="小月亮" />
</p>

<h1 align="center">🌙 小月亮阅读器</h1>

<p align="center">
  <strong>Journey Drives Knowledge</strong><br>
  <em>ArXiv 顶会论文一键阅读 · 双语对照 · AI 深度解读 · 极致 EPUB 体验</em>
</p>

<p align="center">
  <a href="https://moon.jdk.plus"><img src="https://img.shields.io/badge/官网-moon.jdk.plus-8ab4ff?style=flat-square" alt="官网"></a>
  <a href="https://moon.jdk.plus#start"><img src="https://img.shields.io/badge/平台-macOS%20%7C%20Windows%20%7C%20Linux%20%7C%20Android-42b983?style=flat-square" alt="平台"></a>
  <a href="#ai"><img src="https://img.shields.io/badge/AI-Copilot%20%7C%20MCP%20%7C%20多智能体-c9a6ff?style=flat-square" alt="AI"></a>
  <a href="mailto:dev@jdk.plus"><img src="https://img.shields.io/badge/联系-dev%40jdk.plus-ffe9a8?style=flat-square" alt="联系"></a>
</p>
...
<table>
<tr>
<td width="33%"><div align="center"><b>📡 ArXiv 顶会推荐</b><br><sub>智能聚合顶会论文，一键沉浸阅读</sub></div></td>
<td width="33%"><div align="center"><b>🌐 双语对照阅读</b><br><sub>原文译文段落级并排，滚动同步</sub></div></td>
...
<tr>
<td width="33%"><div align="center"><b>🕸️ 多智能体编排</b><br><sub>解读 / 解释 / 翻译 / 导航分工协作</sub></div></td>
<td width="33%"><div align="center"><b>💾 持久记忆</b><br><sub>跨会话自动提取，可查可删</sub></div></td>
<td width="33%"><div align="center"><b>🛡️ 行动审批</b><br><sub>写操作执行前弹卡确认</sub></div></td>
</tr>
<tr>
...
<tr>
<td width="50%"><div align="center"><b>🕸️ 多智能体编排</b><br><sub>Leader 委派专业子 agent（论文解读员 / 代码解释员 / 翻译员 / 文档导航员），进度卡实时可见</sub></div></td>
<td width="50%"><div align="center"><b>💬 多会话管理</b><br><sub>搜索、置顶、重命名、删除，IndexedDB 持久化，旧数据自动迁移</sub></div></td>
</tr>
<tr>
<td width="50%"><div align="center"><b>🚀 文档任务</b><br><sub>「边读边记笔记」「逐章摘要」长任务，翻章自动运行 AI，可暂停 / 恢复 / 重试</sub></div></td>
<td width="50%"><div align="center"><b>🔌 MCP 接入</b><br><sub>HTTP / stdio 双传输接入外部工具，工具以 <code>mcp__</code> 前缀注入对话</sub></div></td>
</tr>
</table>
</div>
...
<p align="center">
  <a href="https://moon.jdk.plus#start"><img src="https://img.shields.io/badge/Download-前往下载页-42b983?style=for-the-badge" alt="下载"></a>
</p>
...
<p align="center">
  <strong>小月亮阅读器</strong> · JDK = <em>Journey Drives Knowledge</em><br>
